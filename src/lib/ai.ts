...
import { REPO_CATEGORIES, type RepoCategory } from "./repo-categories";
      ...
      messages: [
        ...
        },
        {
          ...
          content: [
            ...
            "输出 JSON 结构必须为：",
            '{"summary":"中文总结","category":"固定分类之一","tags":["标签1","标签2","标签3"],"analysisReason":"分类与标签判断理由"}',
            "要求：",
            "1. summary 使用 2 到 4 句中文，总结项目用途、适用场景和主要特点。",
            "2. category 必须严格来自给定候选集。",
            "3. tags 输出 3 到 6 个简洁中文标签，避免重复。",
            "4. analysisReason 用中文解释为何归入该分类，以及标签判断依据。",
